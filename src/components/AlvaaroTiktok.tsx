...
const clientKey ="sbawbotc4bs285ol8w";
const redirectUri =
...
const AlvaaroTiktokLogin = () => {
  ...
  return (
    <div className="">
      <h1 className=" text-3xl text-center m-12">This Alvaaro Project </h1>
      <div className="flex justify-center">

      <button className="bg-red-400 m-12 p-8  rounded-full" onClick={handleLogin}>
        Login with TikTok(Alvaaro)
      </button>
      </div>
    </div>
  );
...
export default AlvaaroTiktokLogin;
